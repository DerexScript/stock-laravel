            ...
            <div class="col-8">
                <form class="needs-validation" novalidate action="{{ route('auth.verifyLogin') }}" method="POST">
                    ...
                    <div class="form-floating mt-1">
                        <input type="text" name="credential" class="form-control {{-- $errors->has('credential') ? 'is-invalid' : '' --}}" id="email"
                            placeholder=""
                    ...
                    <p class="text-info">Não tem uma conta?
                        <a href="{{ route('auth.create') }}" class="text-decoration-none text-primary">Registre-se</a>
                        <a href="" class="text-decoration-none text-primary float-end">Redefinir Senha</a>
                    </p>
